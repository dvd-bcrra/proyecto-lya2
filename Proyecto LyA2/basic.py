...
class BuiltInFunction(BaseFunction):
  ...
  def execute_calcular(self,exec_ctx):
    sueldo = exec_ctx.symbol_table.get("sueldo")
    horas  = exec_ctx.symbol_table.get("horas")
    salida = 0
    hs=horas.value
    phs=sueldo.value
    extras=hs-40
    ...
    return RTResult().success(Number.null)
  execute_calcular.arg_names = ["sueldo","horas"]
...
BuiltInFunction.calcular    = BuiltInFunction("calcular")
#######################################
# CONTEXT
#######################################
...
global_symbol_table.set("CALCULAR",BuiltInFunction.calcular)
